...
- **One concern per unit:** Each hook, component, or file should own exactly one responsibility. Mixing concerns increases complexity and kills testability — refactor early, before it compounds.
